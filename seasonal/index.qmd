...
This report is a summary of the **fine particulate matter (PM<sub>2.5</sub>)** observation data in Canada for the **past 6 months** from the regulatory **Federal Equivalent Method (FEM)** monitors and the network of low-cost monitors from **PurpleAir (PA)**.
...
texts = sapply(prov_pretty, \(prov) {
  ...
  if (nrow(worst) == 0) {
    ...
    paste0(
      ...
      " &mu;g m<sup>-3</sup> and ",
      worst_summs$max_range,
      " &mu;g m<sup>-3</sup>, respectively. The longest event (",
      worst_summs$dur_max,
      ...
      " &mu;g m<sup>-3</sup> and an overall mean of ",
      worst_summs$dur_mean,
      " &mu;g m<sup>-3</sup> was observed."
    )
  }
})
