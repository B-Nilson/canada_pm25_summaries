...
plot_paths[['FEM and PA']] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$prov_grids[['FEM and PA']])
```
...
plot_paths[['FEM']] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$prov_grids[['FEM']])
```
...
plot_paths[['PA']] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$prov_grids[['PA']])
```
...
for (pt_name in names(provinces_n_territories)) {
  ...
  cat(
    plot_paths[[pt_abbr]] |>
      stringr::str_replace(report_dir_esc, "./") |>
      plot_card(quarto_captions$zone_grids[[pt_abbr]]),
    "\n"
  )
}
