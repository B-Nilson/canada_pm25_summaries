...
summaries$donuts$paths$median_fem_and_pa |>
  ...
  plot_card(quarto_captions$median_donuts$`FEM and PA`)
```

```{r include=TRUE, results = 'asis'}
summaries$donuts$paths$max_fem_and_pa |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$max_donuts$`FEM and PA`)
```

#### FEM Only

```{r include=TRUE, results = 'asis'}
summaries$donuts$paths$median_fem |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$median_donuts$`FEM`)
```

```{r include=TRUE, results = 'asis'}
summaries$donuts$paths$max_fem |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$max_donuts$`FEM`)
```

#### PA Only

```{r include=TRUE, results = 'asis'}
summaries$donuts$paths$median_pa |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$median_donuts$`PA`)
```

```{r include=TRUE, results = 'asis'}
summaries$donuts$paths$max_pa |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$max_donuts$`PA`)
```
...
```{r include=TRUE, results = 'asis'}
coverage_table_paths$total |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$coverage$total)
```

#### First Nations and Inuit Communities

```{r include=TRUE, results = 'asis'}
coverage_table_paths$fnic |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$coverage$fnic)
```

#### Urban Population

```{r include=TRUE, results = 'asis'}
coverage_table_paths$urban |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$coverage$urban)
```

#### Rural Population

```{r include=TRUE, results = 'asis'}
coverage_table_paths$rural |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$coverage$rural)
```
...
daily_zone_path |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$daily_zones, iframe = TRUE, plot_title)
```
...
boxplot_paths[["FEM and PA"]] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$boxplots[["FEM and PA"]], iframe = TRUE)
```
...
boxplot_paths[["FEM"]] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$boxplots[["FEM"]], iframe = TRUE)
```
...
boxplot_paths[["PA"]] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$boxplots[["PA"]], iframe = TRUE)
```
...
```{r include=TRUE, results = 'asis'}
community_boxplot_paths[["FEM and PA"]] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$community_boxplots[["FEM and PA"]], iframe = TRUE)
```

#### FEM Only

```{r include=TRUE, results = 'asis'}
community_boxplot_paths[["FEM"]] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$community_boxplots[["FEM"]], iframe = TRUE)
```

#### PA Only

```{r include=TRUE, results = 'asis'}
community_boxplot_paths[["PA"]] |>
  stringr::str_replace(report_dir_esc, "./") |>
  plot_card(quarto_captions$community_boxplots[["PA"]], iframe = TRUE)
```
