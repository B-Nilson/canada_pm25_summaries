...
format:
  html:
    pagetitle: "Monthly Canada PM<sub>2.5</sub> Summary"
    include-in-header: 
      - text: |
          <script src="https://code.jquery.com/jquery-4.0.0.min.js"></script>
          <script>
            var main_header = "#analysis-of-past-month-of-pm2\\.5-observations";
            $(main_header).hide();
            $(main_header + " > .panel-tabset .primary-tabset").hide();
            var icons = [
...
This report is a summary of the **fine particulate matter (PM<sub>2.5</sub>)** observation data in Canada for the **past 1 month** from the regulatory **Federal Equivalent Method (FEM)** monitors and the network of low-cost monitors from **PurpleAir (PA)**. This report is automatically updated at the end of every month. 
