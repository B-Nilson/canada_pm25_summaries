...
hours_to_summarise = seq(min_date, max_date, "1 hours")

caption_range = paste(
  min_date |> format("%b %d, %Y %H:%M UTC"),
  "to",
  max_date |> format("%b %d %H:%M UTC")
)
plot_captions = paste(
  "Obs. from Canadian",
...
obs = load_report_data(min_date, max_date, max_pm25_allowed) |>
