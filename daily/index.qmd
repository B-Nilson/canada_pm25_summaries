...
There was <strong>`r summaries$aqhi_p_counts$overall$FEM[4]` FEM monitors</strong> and <strong>`r summaries$aqhi_p_counts$overall$PA[4]` PA monitors</strong> in Canada with a 24-hour mean PM<sub>2.5</sub> concentration <strong>exceeding 100 {{< pm_units >}}</strong>
...
There was <strong>`r summaries$aqhi_p_counts$overall$FEM[3]` FEM monitors</strong> and <strong>`r summaries$aqhi_p_counts$overall$PA[3]` PA monitors</strong> in Canada with a 24-hour mean PM<sub>2.5</sub> concentration <strong>between 60 and 100 {{< pm_units >}}</strong>
...
concentration in Canada from the FEM network in the past 24 hours (`r boxplot_vals$FEM[[1]]$PM` {{< pm_units >}}).
...
had the highest 24-hour mean in Canada from the FEM network (`r round(boxplot_vals$FEM[[2]]$PM,1)`{{< pm_units >}}).
...
concentration in Canada from the PA network in the past 24 hours (`r boxplot_vals$PA[[1]]$PM` {{< pm_units >}}).
...
had the highest 24-hour mean in Canada from the PA network (`r round(boxplot_vals$PA[[2]]$PM,1)`{{< pm_units >}}).
...
which experienced elevated PM<sub>2.5</sub> concentrations  (> 30 {{< pm_units >}})
