...
plot_text_template <- "Monitor counts and frequencies of median AQHI risk levels for %s PM<sub>2.5</sub> monitoring sites within each province/territory. The number within each circle indicates the total number of monitors with data in that area. Percents indicate the amount of those monitors with a median AQHI risk at that level for this report." |>
