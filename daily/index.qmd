...
overall_summary_table_captions <- "Canadian %s PM<sub>2.5</sub> monitor observation summaries. 
...
`r build_tabs(monitor_groups, map_paths, map_texts, report_dir, overall_summary_table_buttons, overall_summary_tables, overall_summary_table_captions, iframe = TRUE)`
