...
map_card <- map_path |>
  stringr::str_replace(stringr::fixed(params$report_dir), "./") |>
  plot_card(
...
`r build_tabs(monitor_groups, summaries$donuts$paths$median, quarto_captions$median_donuts, params$report_dir, plot_timestamp = plot_timestamp)`

## Max PM<sub>2.5</sub>

`r tab_explainers$network_tabs`

`r build_tabs(monitor_groups, summaries$donuts$paths$max, quarto_captions$max_donuts, params$report_dir, plot_timestamp = plot_timestamp)`
...
`r build_tabs(monitor_groups, prov_grid_paths, quarto_captions$prov_grids, params$report_dir, plot_timestamp = plot_timestamp)`

## Region Level 

`r tab_explainers$prov_terr_tabs`

`r build_tabs(provinces_n_territories, fcst_grid_paths, quarto_captions$zone_grids, params$report_dir, plot_timestamp = plot_timestamp)`
...
`r build_tabs(monitor_groups, boxplots$paths, quarto_captions$boxplots, params$report_dir, iframe = TRUE, iframe_height = 526, plot_timestamp = plot_timestamp)`
