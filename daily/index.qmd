...
table_caption <- "Canadian {{< var terms.FEM >}} and {{< var terms.PA >}} monitor {{< var terms.pm25 >}} observation summary for %s. 
...
table_caption <- "Canadian communities with at least one nearby {{< var terms.FEM >}} or {{< var terms.PA >}} {{< var terms.pm25 >}} monitor with data from %s. 
The table is sortable, filterable, and has multiple pages.
