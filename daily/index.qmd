...
`r build_tabs(monitor_groups, summaries$donuts$paths$median, quarto_captions$median_donuts, params$type, plot_timestamp = plot_timestamp)`

## Max PM<sub>2.5</sub>

`r tab_explainers$network_tabs`

`r build_tabs(monitor_groups, summaries$donuts$paths$max, quarto_captions$max_donuts, params$type, plot_timestamp = plot_timestamp)`
...
`r build_tabs(monitor_groups, prov_grid_paths, quarto_captions$prov_grids, params$type, plot_timestamp = plot_timestamp)`
...
`r build_tabs(monitor_groups, boxplots$paths, quarto_captions$boxplots, params$type, iframe = TRUE, iframe_height = 526, plot_timestamp = plot_timestamp)`
