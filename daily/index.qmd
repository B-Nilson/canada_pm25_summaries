...
quarto_captions <- list(
  ...
  boxplots = paste(
    ...
    "Hover over the boxplot (away from the points) to see the min/median/max and 25th/75th percentiles for that province.",
    "See the menu in the top right of the plot for more."
  ) |>
    sprintf(names(monitor_groups), fig_caption_date_range) |>
    setNames(monitor_groups),
  prov_grids = paste(
    "Median and maximum hourly PM2.5 concentrations",
    "for all %s monitoring sites in each p/t from %s.",
