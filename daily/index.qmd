...
`r build_tabs(monitor_groups, map_paths, map_texts, report_dir, overall_summary_table_buttons, overall_summary_tables, overall_summary_table_captions, iframe = TRUE, iframe_height = c(600, 526))`
